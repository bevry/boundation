...
async function init () {
	...
	*/
	...
	await util.write('.travis.yml',
		'# THIS FILE IS AUTO-GENERATED BY BEVRY/BASED DO NOT MODIFY\n' + yaml.dump(travis) + '\n# THIS FILE IS AUTO-GENERATED BY BEVRY/BASED DO NOT MODIFY\n'
	)
	await Promise.all([
		util.spawn(['travis', 'encrypt', `${answers.slackSubdomain}:${answers.slackToken}#updates`, '--add', 'notifications.slack']),
		util.spawn(['travis', 'encrypt', answers.travisEmail, '--add', 'notifications.email.recipients'])
	])
